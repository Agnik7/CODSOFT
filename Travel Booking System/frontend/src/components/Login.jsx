      ...
      <main class="container flex flex-col lg:flex-row ">
          ...
          <section class="form-section p-[5rem] lg:mx-[3rem]">
              ...
              <div class="form flex items-center flex-col gap-[3rem]">
                  <input type="email" name="Email" placeholder="Email" id="email" class="bg-[transparent] border-b-4 outline-none border-[#003049] text-[1.3rem] px-2"value={email} onChange={(e) => { setEmail(e.target.value) }}/>
                  <input type="password" name="Password" placeholder="Password" id="password" class="bg-[transparent] border-b-4 outline-none border-[#003049] text-[1.3rem] px-2" value={password} onChange={(e) => { setPassword(e.target.value) }}/>
                  <button class="text-[1.5rem] text-slate-200 bg-[#003049] px-[3.5rem] py-[0.5rem] hover:text-black hover:bg-[#669bbc] rounded-full" id="login_button" onClick={handleLogin}>Login</button>
